...
async function main() {
  ...
  // Step 7: Insert musicas_repertorio (global bank - todos os artistas escolhem do mesmo repertório)
  console.log('\nStep 7: Create musicas_repertorio...');
  const musicas = [
    { titulo: 'Erro Planejado', artista_nome: 'Luan Santana', genero: 'Sertanejo', duracao_seg: 210 },
    { titulo: 'Namorando Ou Não', artista_nome: 'Luan Santana', genero: 'Sertanejo', duracao_seg: 195 },
    { titulo: 'Zona de Perigo', artista_nome: 'Luan Santana', genero: 'Sertanejo', duracao_seg: 200 },
    { titulo: 'Mordaça', artista_nome: 'Luan Santana', genero: 'Sertanejo', duracao_seg: 198 },
    { titulo: 'Lua Cheia', artista_nome: 'Luan Santana', genero: 'Sertanejo', duracao_seg: 205 },
    { titulo: 'Aquela Pessoa', artista_nome: 'Henrique & Juliano', genero: 'Sertanejo', duracao_seg: 185 },
    { titulo: 'Rancorosa', artista_nome: 'Henrique & Juliano', genero: 'Sertanejo', duracao_seg: 190 },
    { titulo: 'A Maior Saudade', artista_nome: 'Henrique & Juliano', genero: 'Sertanejo', duracao_seg: 205 },
    { titulo: 'Vai Dar PT', artista_nome: 'Guilherme & Benuto', genero: 'Sertanejo', duracao_seg: 215 },
    { titulo: '3 da Manhã', artista_nome: 'Guilherme & Benuto', genero: 'Sertanejo', duracao_seg: 188 },
    { titulo: 'Coração Na Cama', artista_nome: 'Hugo & Guilherme', genero: 'Sertanejo', duracao_seg: 198 },
    { titulo: 'Leão', artista_nome: 'Marília Mendonça', genero: 'Sertanejo', duracao_seg: 175 },
    { titulo: 'Amava Nada', artista_nome: 'Marília Mendonça', genero: 'Sertanejo', duracao_seg: 188 },
    { titulo: 'Folgado', artista_nome: 'Marília Mendonça', genero: 'Sertanejo', duracao_seg: 192 },
    { titulo: 'Todo Mundo Menos Você', artista_nome: 'Marília Mendonça', genero: 'Sertanejo', duracao_seg: 195 },
    { titulo: 'Agora É Tarde', artista_nome: 'Marília Mendonça', genero: 'Sertanejo', duracao_seg: 202 },
    { titulo: 'Não Me Envergonha', artista_nome: 'Gusttavo Lima', genero: 'Sertanejo', duracao_seg: 202 },
    { titulo: 'Bloqueado', artista_nome: 'Gusttavo Lima', genero: 'Sertanejo', duracao_seg: 195 },
    { titulo: 'Cem Anos', artista_nome: 'Gusttavo Lima', genero: 'Sertanejo', duracao_seg: 210 },
    { titulo: 'Balada', artista_nome: 'Gusttavo Lima', genero: 'Sertanejo', duracao_seg: 205 },
    { titulo: 'Alô', artista_nome: 'Gusttavo Lima', genero: 'Sertanejo', duracao_seg: 198 },
    { titulo: 'Lancinho', artista_nome: 'Gusttavo Lima', genero: 'Sertanejo', duracao_seg: 188 },
    { titulo: 'Nota de Real', artista_nome: 'Zé Neto & Cristiano', genero: 'Sertanejo', duracao_seg: 195 },
    { titulo: 'Foto de Couchê', artista_nome: 'Zé Neto & Cristiano', genero: 'Sertanejo', duracao_seg: 188 },
    { titulo: 'Fake News', artista_nome: 'Zé Neto & Cristiano', genero: 'Sertanejo', duracao_seg: 202 },
    { titulo: 'Manifesto', artista_nome: 'Zé Neto & Cristiano', genero: 'Sertanejo', duracao_seg: 198 },
    { titulo: 'Largadouro', artista_nome: 'Zé Neto & Cristiano', genero: 'Sertanejo', duracao_seg: 185 },
    { titulo: 'Recairei', artista_nome: 'Zé Neto & Cristiano', genero: 'Sertanejo', duracao_seg: 192 },
    { titulo: 'Meu Bem', artista_nome: 'Jorge & Mateus', genero: 'Sertanejo', duracao_seg: 178 },
    { titulo: 'Cheirosa', artista_nome: 'Jorge & Mateus', genero: 'Sertanejo', duracao_seg: 195 },
    { titulo: 'Hackearam-Me', artista_nome: 'Jorge & Mateus', genero: 'Sertanejo', duracao_seg: 200 },
    { titulo: 'Da Vontade', artista_nome: 'Jorge & Mateus', genero: 'Sertanejo', duracao_seg: 185 },
    { titulo: 'Insalubre', artista_nome: 'Jorge & Mateus', genero: 'Sertanejo', duracao_seg: 192 },
    { titulo: 'Controle Remoto', artista_nome: 'Jorge & Mateus', genero: 'Sertanejo', duracao_seg: 198 },
    { titulo: 'Propaganda', artista_nome: 'Jorge & Mateus', genero: 'Sertanejo', duracao_seg: 205 },
    { titulo: 'Canudinho', artista_nome: 'Simone Mendes', genero: 'Sertanejo', duracao_seg: 188 },
    { titulo: 'Erro Gostoso', artista_nome: 'Simone Mendes', genero: 'Sertanejo', duracao_seg: 192 },
    { titulo: 'Inesquecível', artista_nome: 'Simone Mendes', genero: 'Sertanejo', duracao_seg: 195 },
    { titulo: 'Graveto', artista_nome: 'Simone Mendes', genero: 'Sertanejo', duracao_seg: 188 },
    { titulo: 'Volta Com Você', artista_nome: 'Simone Mendes', genero: 'Sertanejo', duracao_seg: 202 },
    { titulo: 'Mequetrefe', artista_nome: 'Simone Mendes', genero: 'Sertanejo', duracao_seg: 190 },
    { titulo: 'Oi Tchau', artista_nome: 'João Gomes', genero: 'Sertanejo', duracao_seg: 195 },
    { titulo: 'Dói', artista_nome: 'João Gomes', genero: 'Sertanejo', duracao_seg: 188 },
    { titulo: 'Jardim', artista_nome: 'João Gomes', genero: 'Sertanejo', duracao_seg: 202 },
    { titulo: 'Rapadura', artista_nome: 'João Gomes', genero: 'Sertanejo', duracao_seg: 198 },
    { titulo: 'Coração Dividido', artista_nome: 'Kayky', genero: 'Sertanejo', duracao_seg: 185 },
    { titulo: 'Corno Forte', artista_nome: 'Kayky', genero: 'Sertanejo', duracao_seg: 192 },
    { titulo: 'Agora eu sei', artista_nome: 'Kayky', genero: 'Sertanejo', duracao_seg: 188 },
    { titulo: 'Malvado', artista_nome: 'Kayky', genero: 'Sertanejo', duracao_seg: 195 },
    { titulo: 'Bebas', artista_nome: 'Mari Fernandez', genero: 'Sertanejo', duracao_seg: 188 },
    { titulo: 'Manda', artista_nome: 'Mari Fernandez', genero: 'Sertanejo', duracao_seg: 195 },
    { titulo: 'Eu Vousso', artista_nome: 'Mari Fernandez', genero: 'Sertanejo', duracao_seg: 202 },
    { titulo: 'Vontade de Morder', artista_nome: 'Mari Fernandez', genero: 'Sertanejo', duracao_seg: 190 },
    { titulo: 'Fala Malandra', artista_nome: 'Luísa Sonza', genero: 'Sertanejo', duracao_seg: 195 },
    { titulo: 'Penhasco', artista_nome: 'Luísa Sonza', genero: 'Sertanejo', duracao_seg: 202 },
    { titulo: 'Bombonzinho', artista_nome: 'Luísa Sonza', genero: 'Sertanejo', duracao_seg: 188 },
    { titulo: 'A Usina', artista_nome: 'Teto', genero: 'Sertanejo', duracao_seg: 195 },
    { titulo: 'Quando Eu Era Belo', artista_nome: 'Teto', genero: 'Sertanejo', duracao_seg: 202 },
    { titulo: 'Bebida e Console', artista_nome: 'Teto', genero: 'Sertanejo', duracao_seg: 198 },
    { titulo: 'Barbie', artista_nome: 'Teto', genero: 'Sertanejo', duracao_seg: 185 },
    { titulo: 'Deu Onde?', artista_nome: 'Lula', genero: 'Sertanejo', duracao_seg: 192 },
    { titulo: 'Mete a Mão', artista_nome: 'Lula', genero: 'Sertanejo', duracao_seg: 188 },
    { titulo: 'Tremendo', artista_nome: 'Lula', genero: 'Sertanejo', duracao_seg: 195 },
    { titulo: 'Sextou', artista_nome: 'Tiago Nova', genero: 'Sertanejo', duracao_seg: 202 },
    { titulo: 'Pedaço de mim', artista_nome: 'Tiago Nova', genero: 'Sertanejo', duracao_seg: 198 },
    { titulo: 'Maldivas', artista_nome: 'Ana Castela', genero: 'Sertanejo', duracao_seg: 195 },
    { titulo: 'Surtida', artista_nome: 'Ana Castela', genero: 'Sertanejo', duracao_seg: 188 },
    { titulo: 'Bipolar', artista_nome: 'Ana Castela', genero: 'Sertanejo', duracao_seg: 192 },
    { titulo: 'Larguei', artista_nome: 'Ana Castela', genero: 'Sertanejo', duracao_seg: 185 },
    { titulo: 'Campo de Batata', artista_nome: 'Japarote', genero: 'Sertanejo', duracao_seg: 198 },
    { titulo: 'Xote das Maid', artista_nome: 'Wesley Safadão', genero: 'Sertanejo', duracao_seg: 205 },
    { titulo: 'Garota Vip', artista_nome: 'Wesley Safadão', genero: 'Sertanejo', duracao_seg: 195 },
    { titulo: 'Ninguém É de Nadie', artista_nome: 'Wesley Safadão', genero: 'Sertanejo', duracao_seg: 188 },
    { titulo: 'O Business', artista_nome: 'MC Don Juan', genero: 'Funk', duracao_seg: 210 },
    { titulo: 'Raia D\'Agua', artista_nome: 'MC Don Juan', genero: 'Funk', duracao_seg: 195 },
    { titulo: 'Tubarões', artista_nome: 'Raffael', genero: 'Funk', duracao_seg: 202 },
    { titulo: 'Bumbum', artista_nome: 'Mc Jhow', genero: 'Funk', duracao_seg: 185 },
    { titulo: 'Evidências', artista_nome: 'Chitãozinho & Xororó', genero: 'Sertanejo', duracao_seg: 195 },
    { titulo: 'Fio Dental', artista_nome: 'Ricky Martin', genero: 'Sertanejo', duracao_seg: 188 },
    { titulo: 'Coração Maldito', artista_nome: 'Wesley Safadão', genero: 'Sertanejo', duracao_seg: 202 },
    { titulo: 'Atrasadinha', artista_nome: 'Ferrugem', genero: 'Sertanejo', duracao_seg: 195 },
    { titulo: 'Deixa Comigo', artista_nome: 'Wesley Safadão', genero: 'Sertanejo', duracao_seg: 198 },
    { titulo: 'Tô Lorado', artista_nome: 'Pablo', genero: 'Sertanejo', duracao_seg: 210 },
    { titulo: 'Nega', artista_nome: 'Pablo', genero: 'Sertanejo', duracao_seg: 185 },
    { titulo: 'Beijinho no Ombro', artista_nome: 'Wesley Safadão', genero: 'Sertanejo', duracao_seg: 188 },
    { titulo: 'Quer Namorar Comigo', artista_nome: 'Hugo & Guilherme', genero: 'Sertanejo', duracao_seg: 195 },
    { titulo: 'Sinal dos Jogos', artista_nome: 'Marília Mendonça', genero: 'Sertanejo', duracao_seg: 202 },
    { titulo: 'Todo Mundo Vai Gritar', artista_nome: 'Wesley Safadão', genero: 'Sertanejo', duracao_seg: 195 },
    { titulo: 'Chamegot', artista_nome: 'Wesley Safadão', genero: 'Sertanejo', duracao_seg: 198 },
    { titulo: 'Chora no Corote', artista_nome: 'Wesley Safadão', genero: 'Sertanejo', duracao_seg: 202 },
    { titulo: 'Paredão', artista_nome: 'Wesley Safadão', genero: 'Sertanejo', duracao_seg: 188 },
    { titulo: 'Sereia', artista_nome: 'Wesley Safadão', genero: 'Sertanejo', duracao_seg: 195 },
    { titulo: 'Resenha', artista_nome: 'Wesley Safadão', genero: 'Sertanejo', duracao_seg: 202 },
    { titulo: 'Minha Sereia', artista_nome: 'Wesley Safadão', genero: 'Sertanejo', duracao_seg: 198 },
    { titulo: 'Louca', artista_nome: 'Jesse & Mc', genero: 'Sertanejo', duracao_seg: 185 },
    { titulo: 'Gordinha', artista_nome: 'Gusttavo Lima', genero: 'Sertanejo', duracao_seg: 192 },
    { titulo: '10 Anos', artista_nome: 'César Menotti & Fabiano', genero: 'Sertanejo', duracao_seg: 198 },
    { titulo: 'adeira do Meu Pai', artista_nome: 'Bruno & Marrone', genero: 'Sertanejo', duracao_seg: 195 },
    { titulo: 'Vou Rangá', artista_nome: 'Hugo & Guilherme', genero: 'Sertanejo', duracao_seg: 188 },
    { titulo: 'Coração Errante', artista_nome: 'Eduardo Costa', genero: 'Sertanejo', duracao_seg: 205 },
    { titulo: 'Guitarra e Violão', artista_nome: 'Daniel', genero: 'Sertanejo', duracao_seg: 192 },
    { titulo: 'Eu Sem Você', artista_nome: 'Leonardo', genero: 'Sertanejo', duracao_seg: 198 },
    { titulo: 'Tá Rindo de Quê', artista_nome: 'Marília Mendonça', genero: 'Sertanejo', duracao_seg: 185 },
    { titulo: 'Banda do João', artista_nome: 'João Gomes', genero: 'Sertanejo', duracao_seg: 190 },
    { titulo: 'Meteori', artista_nome: 'João Gomes', genero: 'Sertanejo', duracao_seg: 195 },
  ];
