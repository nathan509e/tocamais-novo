  ...
  return (
    ...
    >
      ...
      <div className="relative h-40 overflow-hidden">
        ...
        {featured && (
          <div className="absolute top-3 right-3 bg-neon-purple text-white text-xs font-bold px-2.5 py-1 rounded-full flex items-center gap-1">
      ...
      <div className="p-4">
        <div className="flex items-center justify-between mb-3">
          <div className="flex items-center gap-1.5">
            ...
            <span className="text-gray-500 text-xs">({artist.total_reviews || 0} avaliações)</span>
          </div>
          <div className="text-right">
            <p className="text-[#2ecc71] font-bold text-sm">R$ {base_fee?.toLocaleString()}</p>
